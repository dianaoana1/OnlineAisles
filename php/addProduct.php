...
<nav class="navbar navbar-expand-md bg-dark navbar-dark ">
    ...
    <div class = "container"style="max-width: 100%; height:80%;margin-top:60px;">
        ...
        <tbody>
            ...
            <tr>
            <td class="tg-odd"><input type="text" name="name"></td>
            <td class="tg-odd"><input type="text" name="type"></td>
            <td class="tg-odd"><input type="text" name="price"></td>
            <td class="tg-odd"><input type="text" name="quantity"></td>
            <td class="tg-des"><textarea name="description"></textarea></td>
