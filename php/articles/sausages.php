        ...
        <div class="products">
            <div class="products_row">
                <div class="right-side">
                    ...
                    <h2>Sausages</h2>
                    <img src="../../Images/sausages.jpg" width="400" height="400">
                    <h4 id="price_sausage">$<?php echo $productCurrPrice?></h4>
                    <input type="number" name="quantity" value="1">
                    <input type="submit" id="add-to-cart" name = "18" class="button" value="Add to cart">
                    </form>
                </div>
                <div class="right-side">
                    <h2>Quick description</h2>
                    <p>
                        Depending on the sausages, they can can be high or low in fat and calories but are usually high
                        in protein. Some can even contain chemicals bad for the health. At least they are tasty!
                    </p>
                    <button class="accordion">Full Product description</button>
                    <div class="panel" style = "padding:10px;">
                        <p> <strong>Pair of Linked Sausages</strong>
                            <br/> These no-name sausages dubbed "mystery meat" of aisle 5, while delicious, will probably have questionable side effects on your heart health.
                            <br/>
