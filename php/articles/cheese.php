        ...
        <div class="products">
            <div class="products_row">
                ...
                <div class="right-side">
                    ...
                    <p>
                         Cheese is not only the enemy of people having 
                        lactose intolerance, it is high in saturated fat 
                        and salt leading to cardiovascular disease. 
                        However it still has a lot of calcium and proteins.
                    </p>
                    <button class="accordion">Full Product description</button>
                    <div class="panel">
                        <p>Cheese is a fermented milk product. Its properties are similar to 
                            those of common yogurt. They are all produced through a fermentation
                             process. They also contain lactic acid bacteria that can be healthy.
                              But the concentration of cheese is higher than that of yogurt, which
                               is similar to solid food. , The nutritional value is therefore more
                                abundant. Each kilogram of cheese products are concentrated from 10
                                 kilograms of milk, which are rich in nutrients such as protein, 
                                 calcium, fat, phosphorus and vitamins. They are purely natural foods.
                                  In terms of process, cheese is fermented milk; in terms of nutrition,
